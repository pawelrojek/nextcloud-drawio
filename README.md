...
## Download ##
Current release: [zip](https://github.com/pawelrojek/nextcloud-drawio/releases/download/0.9.4/drawio-v0.9.4.zip) or [tar.gz](https://github.com/pawelrojek/nextcloud-drawio/releases/download/0.9.4/drawio-v0.9.4.tar.gz)
